//Example program #3 from beginner's guide to c
//File chapter11ex3.c

//This program asks the user their state of happiness
//on a scale of 1 to 10 and then gives a custom 2-line message 
...
int main()
{
	...
	//Once the user's level off hapiness is input, a series
	//of is statements test the number against decreasing numbers.
